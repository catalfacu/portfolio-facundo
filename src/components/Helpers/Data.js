const data = [
    {
        text: "Tengo 24 años, soy de la provincia de Mendoza, Argentina🧉, y soy programador web fullstack🧑🏽‍💻, aunque me inclino mas por el desarrollo frontend🖌️.\nSoy un gran fanatico del futbol⚽, la musica🎸 y especialmente la tecnología💻🎮, ya que desde niño siempre tuve la curiosidad y las ganas de saber como funcionaban los videojuegos y las páginas que visitaba🤔.\nAun asi por una u otra situación nunca daba el paso para comenzar a estudiar y querer vivir de la programación😰. \nHasta que un dia algo en mi interior dijo basta, que era tiempo de dedicarle todo mi esfuerzo a lo que de verdad me gustaba🙆🏽😄, y asi fue como empece.\n Luego de pensar y pensar como realizar mi deseo, por fin di el paso y me animé a estudiar🎒👨🏽‍🎓.\nAl comienzo fue muy complicado para mi😰😶, Pero con toda la determinacion que tenia y que todavia tengo, no baje los brazos y logre gracias a todo ese esfuerzo aprender JavaScript, ReactJS, NodeJS, Express, Postgres y Sequelize😄💻🥹. Y asi llego hasta el dia de hoy donde sigo aprendiendo tecnologias mientras busco el trabajo que me permita vivir de lo que me gusta.💛💛💛💪🏽",
